...
public class CarService {
    ...
    public CarService(CarRepository repository, PriceClient priceClient, MapsClient mapsClient) {
        /**
         * TODO: Add the Maps and Pricing Web Clients you create --> DONE
    ...
    public Car findById(Long id) {
        ...
        if (optionalCar.isPresent()) {
            car = optionalCar.get();
            /**
             * TODO: Use the Pricing Web client you create in `VehiclesApiApplication` --> DONE
            ...
            /**
             * TODO: Use the Maps Web client you create in `VehiclesApiApplication` --> DONE
